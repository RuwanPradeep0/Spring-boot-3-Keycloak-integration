...
1. Clone the repository:
    ```bash
    git clone https://github.com/RuwanPradeep0/Spring-boot-3-Keycloak-integration
    ```
...
3. Create a new Real and name ut ```Ruwan``` or update the ```application.yml``` file and specify your Realm name
4. Create Roles
5. Create Users
